...
function TOOL:LeftClick( trace, attach )
	...
	local brght = math.Clamp( self:GetClientNumber( "brightness" ), -10, 1 )
...
function TOOL.BuildCPanel( CPanel )
	...
	CPanel:AddControl( "Slider", { Label = "#tool.light.brightness", Command = "light_brightness", Type = "Int", Min = -6, Max = 1 } )
