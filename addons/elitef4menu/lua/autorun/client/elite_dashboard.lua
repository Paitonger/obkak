...
function LoadHomePanel()
	...
	HOME_STATS.Paint = function( self, w, h )
		...
		draw.SimpleText( "Данные", "RP_SubFontThick", 24, 20, Color( 190, 190, 190 ) )
	...
	--	draw.SimpleText( "Игроки", "RP_CatFont", 30, 83, Color( 255, 255, 255 ) )
		...
		surface.DrawTexturedRect( 30, 140, 45, 45 )
		
	--	draw.SimpleText( "Деньги", "RP_CatFont", 27, 143, Color( 255, 255, 255 ) )
		...
		draw.SimpleText( 'В твоем кошельке: '..LocalPlayer():getDarkRPVar('money')..'$', "RP_SubFontThick", 92, 154, Color( 190, 190, 190 ) )
