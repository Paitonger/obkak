...
local function hitmanMenu()
      ...
      local bg = vgui.Create 'zhits_frame'
            ...
            bg:Center()
            bg:AddClose()
            bg.title = 'Hitman menu'
            bg.titleDesc = 'View active hits here :D'
            bg.leftTopSize = 0
      ...
      for _, hit in ipairs(zhits.activeHits) do
            ...
            local rlbl = pnl:Add 'DLabel'
                  ...
                  rlbl:SetText(translate 'requester' .. ': ' .. (hit.isRandom and 'None' or (hit.requester and IsValid(hit.requester) and hit.requester:Name() or 'Disconnected')))
            ...
            local desc = pnl:Add 'DLabel'
                  ...
                  desc:SetText(translate 'description' .. ': ' .. (hit.desc or 'None'))
