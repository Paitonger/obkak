...
function STUNGUN.Electrolute( ply, pushdir )
	...
	if ply:GetActiveWeapon():IsValid() and ply:GetActiveWeapon():GetClass() == 'weapon_handcuffed' then return end
	if ply:GetVehicle():IsValid() then return end
	-- Ragdoll
...
hook.Remove("EntityTakeDamage", "Tazer")
...
hook.Remove("Think", "TazerDoRagDmg")
/*
