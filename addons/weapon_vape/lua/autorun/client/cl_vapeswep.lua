...
--	if fx == 1 then particle:SetColor(vape_red_white_blue_chooser(math.random(0,2)/3)) end
	if fx >= 20 then 
	...
	if fx == 2 then particle:SetMaterial(mat) mega = 0.3 end
	if fx == 11 then mat = Material("data/wimages/rytra.png") particle:SetMaterial(mat) mega = 0.3 end
	if fx == 12 then mat = Material("data/wimages/micvol.png") particle:SetMaterial(mat) mega = 0.3 end
